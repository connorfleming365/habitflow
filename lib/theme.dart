...
/// De-emphasized ("muted") text colour, used throughout for subtitles,
/// captions, and disabled-looking labels — historically just
/// `colorScheme.onSurface.withOpacity(x)`. That works fine on Deep Abyss's
